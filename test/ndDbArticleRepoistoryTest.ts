...
test("insert", async (t) => {
    ...
    const article = await t.context.repo.insert(new Article({
        id: 1,
        title: "title",
...
test("delete", async (t) => {
    /* tslint:disable:object-literal-sort-keys */
    const article1 = await t.context.repo.insert(new Article({
        id: 1,
        title: "title1",
        url: "http://example.com",
        host: "example.com",
    ...
    const article2 = await t.context.repo.insert(new Article({
        id: 2,
        title: "title2",
        url: "http://example.com",
        host: "example.com",
    ...
    const article3 = await t.context.repo.insert(new Article({
        id: 3,
        title: "title3",
        url: "http://example.com",
        host: "example.com",
...
test("findByItemId", async (t) => {
    ...
    {
        const article = await t.context.repo.findById(1);
        t.not(article, null);
        t.is((article as Article).title, "title1");
    }

    {
        const article = await t.context.repo.findById(2);
        t.not(article, null);
        t.is((article as Article).title, "title2");
    }

    {
        const article = await t.context.repo.findById(3);
        t.is(article, null);
    }
});
